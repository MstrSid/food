  ...
  */
  ...
  class Producer {
    static produce({
      ...
      new className(img, altimg, title, descr, price, usd, '.menu .container', 'menu__item').render();
    }
  ...
  function bindPostData(form) {
    form.addEventListener('submit', event => {
      ...
      console.log(jsonObj);
      postData(REQUESTS_URL, jsonObj).then(data => {
        console.log(data);
  ...
  class CustomSlider {
    constructor(parentSlider, sliderCounterWrapper, sliderPrevBtn, sliderNextBtn, sliderCountCurrent, sliderCountTotal, sliderWrapper, slideSelector) {
  ...
  new CustomSlider('.offer__slider', '.offer__slider-counter', '.offer__slider-prev', '.offer__slider-next', '#current', '#total', '.offer__slider-wrapper', '.offer__slide').init(); // Calculator
  ...
  function initLocalSettings(selector, activeClass) {
    ...
    elems.forEach(item => item.classList.remove(activeClass));
    elems.forEach(item => {
      ...
      if (item.hasAttribute('id') && item.getAttribute('id') === sex) {
        item.classList.add(activeClass);
      }
    });
  }
